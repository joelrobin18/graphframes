...
class PregelConnect:
    ...
    def withRequiredSrcColumns(self, col: str, *cols: str) -> Self:
        self._required_src_columns = [col] + list(cols)
        return self

    def withRequiredDstColumns(self, col: str, *cols: str) -> Self:
        self._required_dst_columns = [col] + list(cols)
        return self
        ...
        class Pregel(LogicalPlan):
            ...
            def plan(self, session: SparkConnectClient) -> proto.Relation:
                pregel = pb.Pregel(
                    ...
                    required_src_columns=self.required_src_columns,
                    required_dst_columns=self.required_dst_columns,
                )
